...
export default function Classroom() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Section 4: Designing Learning Complexity */}
      <section className="py-20 bg-background">
        <div className="container">
          <div className="grid lg:grid-cols-5 gap-12 items-start">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-serif font-bold text-foreground mb-6">
                {t.classroom.section4Optimizing.title}
              </h2>
            </div>
            <div className="lg:col-span-3 space-y-6">
              <p className="text-lg text-foreground/80 leading-relaxed font-medium">
                {t.classroom.section4Optimizing.p1}
              </p>
              <p className="text-lg text-foreground/80 leading-relaxed">
                {t.classroom.section4Optimizing.p2}
              </p>
              <p className="text-lg text-foreground/80 leading-relaxed">
                {t.classroom.section4Optimizing.p3}
              </p>
              <p className="text-lg text-foreground/80 leading-relaxed font-medium">
                {t.classroom.section4Optimizing.p4}
              </p>
              <ul className="space-y-3 ml-6">
                <li className="text-lg text-foreground/70 leading-relaxed list-disc">
                  {t.classroom.section4Optimizing.point1}
                </li>
                <li className="text-lg text-foreground/70 leading-relaxed list-disc">
                  {t.classroom.section4Optimizing.point2}
                </li>
                <li className="text-lg text-foreground/70 leading-relaxed list-disc">
                  {t.classroom.section4Optimizing.point3}
                </li>
              </ul>
              <p className="text-lg text-foreground/80 leading-relaxed">
                {t.classroom.section4Optimizing.p5}
              </p>
            </div>
          </div>
        </div>
