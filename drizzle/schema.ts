...
/**
 * Blog posts table for Insights/Blog section
 */
...
export const products = mysqlTable("products", {
  ...
  category: mysqlEnum("category", ["language", "math", "spatial", "hands-on", "multi-skill"]).notNull(),
...
/**
 * Settings table for storing configuration (webhook URL, etc.)
 */
